...
var defaultBasePath = 'http://localhost:3000/api/v1';
// ===============================================
...
var UsersApi = /** @class */ (function () {
    ...
    Object.defineProperty(UsersApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    UsersApi.prototype.addInterceptor = function (interceptor) {
     ...
     * @param user
     */
    UsersApi.prototype.createUser = function (user, options) {
    ...
    UsersApi.prototype.deleteUser = function (id, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/users/{id}'
     ...
     * @param id
     */
    UsersApi.prototype.getUserById = function (id, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @param name
     */
    UsersApi.prototype.getUserByName = function (name, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/users/name/{name}'
     ...
     */
    UsersApi.prototype.getUsers = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @param user
     */
    UsersApi.prototype.updateUser = function (id, user, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
